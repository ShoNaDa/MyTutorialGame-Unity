...
public class GameController : MonoBehaviour
{
    ...
    public GameObject[] canvarStartPage;
    ...
    private void Start()
    {
        ...
        scoreTxt.text = "<size=65><color=#FF0000>Best:</color></size><color=#001B00>" + PlayerPrefs.GetInt("score") + "</color>\n<size=55><color=#0000ff>Now:</color></size><color=#001B00>" + 0 + "</color>";
    ...
    private void Update()
    {
        if((Input.GetMouseButtonDown(0) || Input.touchCount > 0) && cubeToPlace != null && allCubes != null && !EventSystem.current.IsPointerOverGameObject())
        {
            ...
            {
                firstCube = true;
                foreach(GameObject obj in canvarStartPage)
                {
                    Destroy(obj);
                }
            }
    ...
    private void MoveCameraChangeBg()
    {
        ...
        scoreTxt.text = "<size=65><color=#FF0000>Best:</color></size><color=#001B00>" + PlayerPrefs.GetInt("score") + "</color>\n<size=55><color=#0000ff>Now:</color></size><color=#001B00>" + maxY + "</color>";
